 ...
 **
رابط البوت | https://discordapp.com/api/oauth2/authorize?client_id=553840110169489420&permissions=8&scope=bot
 **
`);
  message.author.sendEmbed(embed);
   }
 ...
 .setColor("RANDOM")
 .setThumbnail(client.user.avatarURL)     
 .setDescription(" ***welcome To server line bot support*** " + `
 **
رابط السيرفر | https://discord.gg/9p7qNvB
 **
`);
  message.author.sendEmbed(embed);
   }
...
client.on('message', message => {
  ...
  let b5bzlog = client.channels.find("name", "bz-log");
